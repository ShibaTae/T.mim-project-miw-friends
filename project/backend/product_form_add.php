  ...
  <div class="row">
    <form name="addproduct" action="product_form_add_db.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
          <p> ภาพสินค้า </p>
          <input type="file" name="p_img" id="p_img" class="form-control" accept="image/png, image/gif, image/jpeg" multiple />
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-8">
          <p> ราคาสินค้า </p>
          <input type="text" name="p_cost" class="form-control" required placeholder="ราคาสินค้า" />
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-8">
          <p> จำนวนสินค้า </p>
          <input type="text" name="p_amount" class="form-control" required placeholder="จำนวนสินค้า" />
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12">
