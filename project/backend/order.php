...
<head>
  ...
  $query = "SELECT * FROM tbl_order ORDER BY Order_id ASC" or die("Error:" . mysqli_error($con));
        ...
        <table border="2" class="display table table-bordered" id="example1" align="center">
          ...
          do {
            ...
            <tr>
              ...
              <td><a href="order_detail.php?id=<?php echo $row_am['Order_id']; ?>" class="btn btn-primary btn-xs"> รายละเอียด </a> </td>
