  ...
  <div class="row">
    <form name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
      ...
      <div class="form-group">
        <div class="col-sm-9">
          <p> ราคาสินค้า</p>
          <input type="text" name="p_cost" class="form-control" required placeholder="ราคาสินค้า"  value="<?php echo $p_cost; ?>">
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-9">
          <p> จำนวนสินค้า</p>
          <input type="text" name="p_amount" class="form-control" required placeholder="จำนวนสินค้า"  value="<?php echo $p_amount; ?>">
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-12">
